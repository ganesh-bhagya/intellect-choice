            ...
            >
              ...
              >
                ...
                <motion.div variants={cardReveal} className="rounded-b-3xl p-6">
                  <ul className="space-y-8 rounded-2xl mb-10 bg-white p-4">
                    <motion.li variants={cardReveal} className="flex items-center gap-4">
                      ...
                      <div className="min-w-0">
                        <a href={`tel:${SITE.contact.phone}`} className="text-gray-700 hover:text-primary text-base block">
                          {SITE.contact.phone}
                        </a>
                      </div>
                    </motion.li>
                    <motion.li variants={cardReveal} className="flex items-center gap-4">
                      ...
                      <div className="min-w-0">
                        <a href={`mailto:${SITE.contact.email}`} className="text-gray-700 hover:text-primary text-base break-all block">
                          {SITE.contact.email}
                        </a>
                      </div>
                    </motion.li>
                    <motion.li variants={cardReveal} className="flex items-center gap-4">
                      ...
                      <div className="min-w-0">
                        <p className="text-gray-700 text-base leading-snug">{SITE.contact.address}</p>
                      </div>
                    </motion.li>
                  </ul>
